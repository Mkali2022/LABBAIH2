...
Create procedure [LabehDB].[ContractTabb]
(
@ID int,
@Code int,
...
insert into LabehMA.ContractTab (Code,OwnerName,OrganizationAddress, Phone1,Phone2,DateFrom, DateTo,Cost,OrgsSubIdRef  ) values(@Code,@OwnerName,@OrganizationAddress, @Phone1,@Phone2,@DateFrom, @DateTo,@Cost,@OrgsSubIdRef  )
end
